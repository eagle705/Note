...
### Added
- Add Italian translations to `text.yml`. [#318](https://eagle705.github.com/Note/pull/318)
- Add French translations to `text.yml`. [#316](https://eagle705.github.com/Note/pull/316)
- Add German translations to `text.yml`. [#311](https://eagle705.github.com/Note/pull/311)
- Add Spanish translations to `text.yml`. [#300](https://eagle705.github.com/Note/pull/300)

### Fixed
- Fix security issue with seach-data.json by renaming to `.js` and use `relative_url` filter instead of `absolute_url` for all Lunr search scripts. [#323](https://eagle705.github.com/Note/issues/323)
- Remove duplicate `h1` headings for SEO benefit.
- Fix site title and description for page's with a hero image assigned with `page.image`. [#322](https://eagle705.github.com/Note/issues/322)
- Correct stylesheet path in documentation. [#309](https://eagle705.github.com/Note/pull/309)
- Clarify where to customize SCSS variables in `/assets/css/main.scss`. [#293](https://eagle705.github.com/Note/pull/293)

## [3.1.1] - 05-03-2018

### Changed
- Include creation of `navigation.yml` when "starting fresh". [#270](https://eagle705.github.com/Note/issues/270)
- Center hero image. [#289](https://eagle705.github.com/Note/pull/289)
- Update Font Awesome to version [`5.0.12`](https://github.com/FortAwesome/Font-Awesome/blob/master/CHANGELOG.md).
- Do not show `<footer>` in `_includes/entry.html` if there is no `site.read_time` or `entry.date` (typical of collection documents). [#283](https://eagle705.github.com/Note/pull/283)

### Fixed
- Fix documentation links to sample `index.md` file. [#288](https://eagle705.github.com/Note/issues/288)
- Fix "Uncaught TypeError: Cannot read property 'addEventListener' of null" in `main.js` when navigation isn't defined.
- Fix search form from resetting when pressing "Enter". [#278](https://eagle705.github.com/Note/pull/278)
- Fix author links from not displaying correct when a single link is defined in `_config.yml`. [#280](https://eagle705.github.com/Note/issues/280)
- Fix search result excerpts that run together because of implied spaces. [#281](https://eagle705.github.com/Note/pull/281)
- Fix usage of `$site-logo-height` variable in `_global.scss`. [#284](https://eagle705.github.com/Note/pull/284)
...
- Add support for sorting collections by `date` or `title`. [#272](https://eagle705.github.com/Note/pull/272)

### Fixed
- Fix `remote_theme` name in README documentation. [#268](https://eagle705.github.com/Note/pull/268)
...
### Fixed
- Fix MathJax CDN path. [#241](https://eagle705.github.com/Note/pull/241)
...
### Changed
- Change `spin` to `adjust-hue`. [#201](https://eagle705.github.com/Note/issues/201)
...
### Fixed
- Fix search.js interference with other forms. [#194](https://eagle705.github.com/Note/issues/194)
- Fix parenthesis Liquid error in `_layouts/post.html`. [#141](https://eagle705.github.com/Note/issues/141)
...
- Enable Disqus comments globally instead of by post. [#94](https://eagle705.github.com/Note/issues/94)
- Improve Jekyll search feature by removing poorly performing input box overlay on mobile and touch devices [#88](https://eagle705.github.com/Note/issues/88.
...
### Changed
- Change order of navigation and browser upgrade includes. [#32](https://eagle705.github.com/Note/issues/32)
...
### Fixed
- Fix menu close action when clicking outside of it. [#29](https://eagle705.github.com/Note/issues/29)
...
### Fixed
- Fix Pygment CSS conflict with MathJax. [#20](https://eagle705.github.com/Note/issues/20)
- Fix RSS feed link in top navigation. [#21](https://eagle705.github.com/Note/issues/21)
